...
include_once '/var/www/html/imageResize/MysqliDb.php';
...
$folder='/var/www/html/imageResize/newImages/';
...
//print_r($result);exit;
$dir='/var/www/html/imageResize/c_image';

 // foreach($result as  $row){
	$images = glob("$dir/*.{jpg,png,jpg,gif}", GLOB_BRACE);
